...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
	case adventurer:
		caseAdventurer(drawntreasure, state, currentPlayer, temphand, z);
		return 0;

	case council_room:

		caseCouncilRoom(currentPlayer, state, handPos);
	...
	case smithy:
		//+3 Cards
		caseSmithy(currentPlayer, handPos, state);
...
//Newly added function to support Smithy case statement for assignment 2
...
//Newly added function to support Adventurer case statement for assignment 2
...
//Newly added function to support Village case statement for assignment 2
...
//Newly added function to support Great Hall case statement for assignment 2
...
//Newly added function to support Council Room case statement for assignment 2
