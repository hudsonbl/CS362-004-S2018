...
//======================================Test Adventurer=============================================
void newcaseAdventurer(int drawntreasure, struct gameState *state, int currentPlayer, int temphand[MAX_HAND], int z) {
...
int main() {
	...
	newcaseAdventurer(0, &testG, currentPlayer, temphand, 0);
